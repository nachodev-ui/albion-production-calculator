...
marker = "import { RefiningMarketCitySelect } from './RefiningMarketCitySelect'"

if marker in text:
    print('Refining UI already patched.')
    raise SystemExit(0)
...
print('Refining page patched successfully.')
